...
from sky_modules.acquire_module.views_acquire_module import TestModule3View
from sky_modules.acquire_module.model_acquire_module import AcquireData, AcquireInputData

logger = config.get_log(MODULE_NAME)


class AcquireModule(SkyModule):
