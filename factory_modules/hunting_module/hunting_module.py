...
# from factory_modules.hunting_module.execute_channel_task import ExecuteChannelTask
from factory_modules.factory_module import FactoryModule
from factory_modules.hunting_module.load_hunting_database import HuntingDatabase as hd
from factory_modules.hunting_module.views_hunting_module import HuntingModuleChannelView, HuntingModuleHostView, \
    HuntingModuleHistoricalCsvView, HuntingModuleEvidenceOutputsView, HuntingModuleReportView, HuntingModuleManualView
from factory_modules.hunting_module.execute_cmd_task import ExecuteCmdTask
...
class HuntingModule(FactoryModule):
    parsing_module = None
